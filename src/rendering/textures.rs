...
use wgpu::{BindGroup, Device, Queue, BindGroupLayout};

pub const fn tex_cords_to_lin(x: u8, y: u8) -> [f32; 2] {
    let multiplier = 16.0 / 256.0;
...
/// See https://sotrh.github.io/learn-wgpu/beginner/tutorial8-depth/#a-pixels-depth
